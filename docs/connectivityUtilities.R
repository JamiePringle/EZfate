...
#===============================================================================
#start by loading into memory the model grid data. this enables functions that
...
if (FALSE) {
  ...
  #get data to process
  source('getConnectivityData.R') #the library of code to download data
  dataDir<-'theTestData'  #the directory the data will be stored in
  ...
  #now get the data
  E<-getConnectivityData(dataDir,regionName,depth,year,verticalBehavior,month,minPLD,maxPLD)
