...
#will drift in days. Right now, this is limited to 2 to 60 days, by
#interval of 2 days. Please define which Lagrangian pathways you want
#in the function below.
def makeConnectivityAndTranspose(driftTimeDays):
...
if __name__ == "__main__":
    #now run the function to make the habitat over a single Lagrangian drift duration (here called PLD)
    whatPLD=40
    connectFileName,transposeFileName=makeConnectivityAndTranspose(whatPLD)

    #now load the connectivity matrices so you can look at them. 
