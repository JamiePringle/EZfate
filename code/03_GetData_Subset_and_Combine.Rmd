...
-   \`regionName\`\`: A string. To improve download speed, the connectivity data is broken into regions. The github page for EZfate shows a map of the boundaries of the following regions: "theAmericas", "Antarctica", "AsiaPacific", and "EuropeAfricaMiddleEast".
