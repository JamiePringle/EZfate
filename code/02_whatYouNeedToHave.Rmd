...
This file can be retrieved from <https://github.com/JamiePringle/EZfate/releases>.

**Second**: you need to decide upon a directory to store all the connectivity data. In all of the examples below, this is a directory called "connectivityData" that is kept in the same directory as the \*.R files.
