...
-   getConnectivityData.R which downloads the data.

These files can be retrieved from <https://github.com/JamiePringle/EZfate> or downloaded along with this tutorial from **in future, link to release**.
...
To test the installation of these packages, run the code block above, and make sure it works. Don't worry about the tidyverse conflicts.
